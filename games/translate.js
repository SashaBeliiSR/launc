document.addEventListener('DOMContentLoaded', function() {
  ...
  const translations = {
	...
	uk: {
	  ...
	  'Light': 'Світла',
	  'Dark': 'Темна',
	  'Right now launc core is still in development, so shopping is not recommended! Please wait the new update 2024. Contact: awesome.chesbax@yandex.ru': 'Наразі ядро launc все ще перебуває в розробці, тому покупки не рекомендуються! Будь ласка, почекайте нового оновлення 2024. Контакт: awesome.chesbax@yandex.ru',
